...
import 'package:ecom_2/app/components/chat_button.dart';
import 'package:ecom_2/app/components/favourites_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<DetailedProductController>(
        builder: (controller) => SingleChildScrollView(child: Obx(() {
